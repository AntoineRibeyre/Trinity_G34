...
class JWTAuthenticationMiddleware(MiddlewareMixin):
    ...
    def process_request(self, request):
        ...
        if not token:
            print("⚠️ Pas de token, utilisateur anonyme")
        ...
        try:
            ...
            if user_id:
                ...
                print("⚠️ Pas de user_id dans le payload")
                request.user = AnonymousUser()
    ...
    def process_response(self, request, response):
        ...
        if hasattr(request, '_jwt_token_set_cookie') and request._jwt_token_set_cookie:
            ...
            if token:
                ...
                print("⚠️ _jwt_token_set_cookie est True mais pas de token trouvé")
        else:
            print("⚠️ Pas de demande de set cookie")
